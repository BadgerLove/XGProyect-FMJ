...
return [
    ...
    'spy_simulate' => '⚔️ Simulate Battle',
    'spy_activity_title' => 'Espionage action on %s %s', // ok
    'spy_activity_from' => 'Space Monitoring', // ok
    'spy_activity_enemy_seen' => 'A foreign fleet from planet %s %s (%s) was sighted near your planet %s %s.<br>Chance of counter-espionage: %s%%', // ok
