...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['admin.auth', 'admin.authorize'])
        ->group(function () {
            ...
            Route::post('/mailing', [Admin\MailingController::class, 'update'])->name('admin.mailing.update');
            ...
            Route::get('/bots', [Admin\BotsController::class, 'index'])->name('admin.bots');
            Route::post('/bots', [Admin\BotsController::class, 'generate'])->name('admin.bots.generate');
            ...
            Route::get('/registration', [Admin\RegistrationController::class, 'index'])->name('admin.registration');
            Route::post('/registration', [Admin\RegistrationController::class, 'update'])->name('admin.registration.update');
            ...
            Route::get('/server', [Admin\ServerController::class, 'index'])->name('admin.server');
            Route::post('/server', [Admin\ServerController::class, 'update'])->name('admin.server.update');
            Route::get('/statistics', [Admin\StatisticsController::class, 'index'])->name('admin.statistics');
            Route::post('/statistics', [Admin\StatisticsController::class, 'update'])->name('admin.statistics.update');
